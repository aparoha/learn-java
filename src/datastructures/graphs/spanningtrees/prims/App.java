...
public class App {
    ...
    public static void main(String[] args) {
        ...
        vertex3.addEdge(new Edge(vertex3, vertex0, 2));
        vertex3.addEdge(new Edge(vertex3, vertex3, 6));
        vertex3.addEdge(new Edge(vertex3, vertex5, 3));
        vertex3.addEdge(new Edge(vertex3, vertex0, 2));
        vertex3.addEdge(new Edge(vertex3, vertex3, 6));
        ...
        LazyPrimsJarnikAlgorithm primsJarnikAlgorithm = new LazyPrimsJarnikAlgorithm(vertexList);
        primsJarnikAlgorithm.run(vertex0);
        primsJarnikAlgorithm.printSolution();
    }
}
